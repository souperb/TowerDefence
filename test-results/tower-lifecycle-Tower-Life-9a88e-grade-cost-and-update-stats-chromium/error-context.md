...
- Name: tower-lifecycle.spec.ts >> Tower Lifecycle (Inspect, Upgrade, Target Strategy, Sell) >> should upgrade tower tier, deduct upgrade cost, and update stats
- Location: e2e/tower-lifecycle.spec.ts:31:3
