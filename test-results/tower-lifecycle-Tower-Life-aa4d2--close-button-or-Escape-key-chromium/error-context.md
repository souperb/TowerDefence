...
- Name: tower-lifecycle.spec.ts >> Tower Lifecycle (Inspect, Upgrade, Target Strategy, Sell) >> should close detail panel on close button or Escape key
- Location: e2e/tower-lifecycle.spec.ts:102:3
