...
- Name: tower-lifecycle.spec.ts >> Tower Lifecycle (Inspect, Upgrade, Target Strategy, Sell) >> should inspect placed tower and display details panel with correct stats
- Location: e2e/tower-lifecycle.spec.ts:12:3
