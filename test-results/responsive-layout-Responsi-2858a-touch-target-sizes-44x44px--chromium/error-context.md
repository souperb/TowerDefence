...
- Name: responsive-layout.spec.ts >> Responsive Layout and Touch Target Sizing >> should verify detail panel action buttons meet minimum touch target sizes (>= 44x44px)
- Location: e2e/responsive-layout.spec.ts:53:3
