...
- Name: tower-lifecycle.spec.ts >> Tower Lifecycle (Inspect, Upgrade, Target Strategy, Sell) >> should cycle target strategy through First -> Lowest HP -> Closest -> First
- Location: e2e/tower-lifecycle.spec.ts:54:3
...
Call log:
  ...
  - attempting click action
    2 × waiting for element to be visible, enabled and stable
      ...
      - done scrolling
      - <button type="button" data-ref="btnSoundtrack" class="btn btn-secondary btn-soundtrack" aria-label="Toggle Soundtrack (Modern Electro / Retro 8-Bit)" title="Soundtrack: Modern Electro (Click to switch to 8-Bit)">…</button> from <div id="ui-layer" class="ui-layer">…</div> subtree intercepts pointer events
...
- generic [ref=e3]:
  - generic:
    ...
    - navigation "Tower Build Toolbar" [ref=e46]:
      - generic [ref=e47]:
        - button "Build Energy Lance (100 Gold)" [ref=e48] [cursor=pointer]:
          - generic [ref=e49]: "1"
          - generic [ref=e63]:
            - generic [ref=e64]: Energy Lance
            - generic [ref=e65]: 100g
        - button "Build Plasma Mortar (150 Gold)" [active] [pressed] [ref=e66] [cursor=pointer]:
          - generic [ref=e67]: "2"
          - generic [ref=e80]:
