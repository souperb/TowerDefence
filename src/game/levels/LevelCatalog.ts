...
const LEVEL_1_WAVES: WaveDefinition[] = [
  {
    ...
    rewardScore: 60,
    spawnGroups: [
      { creepType: 'basic', count: 6, intervalSeconds: 1.4, startDelaySeconds: 0 },
    ],
  },
  {
    waveNumber: 2,
    ...
    spawnGroups: [
      ...
      { creepType: 'fast', count: 3, intervalSeconds: 0.9, startDelaySeconds: 6.0 },
    ],
  },
  {
    waveNumber: 3,
    ...
    spawnGroups: [
      ...
      { creepType: 'fast', count: 5, intervalSeconds: 0.8, startDelaySeconds: 5.0 },
    ],
  },
  {
    waveNumber: 4,
    ...
    spawnGroups: [
      ...
      { creepType: 'tank', count: 2, intervalSeconds: 2.5, startDelaySeconds: 6.0 },
    ],
  },
  {
    waveNumber: 5,
    ...
    rewardScore: 240,
    spawnGroups: [
      { creepType: 'fast', count: 8, intervalSeconds: 0.75, startDelaySeconds: 0 },
      { creepType: 'basic', count: 8, intervalSeconds: 0.9, startDelaySeconds: 4.0 },
      { creepType: 'tank', count: 2, intervalSeconds: 2.2, startDelaySeconds: 9.0 },
    ],
  },
  {
    waveNumber: 6,
    ...
    rewardScore: 350,
    spawnGroups: [
      { creepType: 'tank', count: 3, intervalSeconds: 2.0, startDelaySeconds: 0 },
      { creepType: 'basic', count: 10, intervalSeconds: 0.8, startDelaySeconds: 4.0 },
      { creepType: 'fast', count: 6, intervalSeconds: 0.7, startDelaySeconds: 9.0 },
      { creepType: 'tank', count: 2, intervalSeconds: 2.0, startDelaySeconds: 14.0 },
    ],
  },
];
...
const LEVEL_2_WAVES: WaveDefinition[] = [
  {
    ...
    rewardScore: 70,
    spawnGroups: [
      { creepType: 'basic', count: 7, intervalSeconds: 1.3, startDelaySeconds: 0 },
    ],
  },
  {
    waveNumber: 2,
    ...
    rewardScore: 100,
    spawnGroups: [
      { creepType: 'basic', count: 8, intervalSeconds: 1.1, startDelaySeconds: 0 },
      { creepType: 'fast', count: 4, intervalSeconds: 0.8, startDelaySeconds: 5.0 },
    ],
  },
  {
    waveNumber: 3,
    ...
    spawnGroups: [
      { creepType: 'basic', count: 8, intervalSeconds: 1.0, startDelaySeconds: 0 },
      { creepType: 'tank', count: 2, intervalSeconds: 2.2, startDelaySeconds: 5.0 },
      { creepType: 'fast', count: 4, intervalSeconds: 0.8, startDelaySeconds: 9.0 },
    ],
  },
  {
    waveNumber: 4,
    ...
    rewardScore: 220,
    spawnGroups: [
      { creepType: 'fast', count: 8, intervalSeconds: 0.7, startDelaySeconds: 0 },
      { creepType: 'basic', count: 8, intervalSeconds: 0.9, startDelaySeconds: 4.0 },
      { creepType: 'tank', count: 2, intervalSeconds: 2.0, startDelaySeconds: 9.0 },
    ],
  },
  {
    waveNumber: 5,
    ...
    spawnGroups: [
      { creepType: 'tank', count: 3, intervalSeconds: 2.0, startDelaySeconds: 0 },
      { creepType: 'basic', count: 10, intervalSeconds: 0.8, startDelaySeconds: 4.0 },
      { creepType: 'fast', count: 6, intervalSeconds: 0.7, startDelaySeconds: 10.0 },
    ],
  },
  {
    waveNumber: 6,
    ...
    rewardScore: 400,
    spawnGroups: [
      { creepType: 'tank', count: 4, intervalSeconds: 1.8, startDelaySeconds: 0 },
      { creepType: 'fast', count: 10, intervalSeconds: 0.6, startDelaySeconds: 4.0 },
      { creepType: 'basic', count: 10, intervalSeconds: 0.7, startDelaySeconds: 9.0 },
    ],
  },
  {
    waveNumber: 7,
    ...
    spawnGroups: [
      { creepType: 'tank', count: 3, intervalSeconds: 2.0, startDelaySeconds: 0 },
      { creepType: 'boss', count: 1, intervalSeconds: 1.0, startDelaySeconds: 5.0 },
      { creepType: 'fast', count: 8, intervalSeconds: 0.6, startDelaySeconds: 8.0 },
      { creepType: 'basic', count: 10, intervalSeconds: 0.7, startDelaySeconds: 12.0 },
      { creepType: 'tank', count: 2, intervalSeconds: 2.0, startDelaySeconds: 17.0 },
    ],
  },
];
...
const LEVEL_3_WAVES: WaveDefinition[] = [
  ...
  },
  {
    ...
    rewardScore: 120,
    spawnGroups: [
      { creepType: 'fast', count: 7, intervalSeconds: 0.8, startDelaySeconds: 0 },
      { creepType: 'basic', count: 8, intervalSeconds: 0.9, startDelaySeconds: 4.0 },
      { creepType: 'tank', count: 2, intervalSeconds: 2.2, startDelaySeconds: 9.0 },
    ],
  },
  ...
  },
  {
    ...
    rewardScore: 250,
    spawnGroups: [
      { creepType: 'fast', count: 10, intervalSeconds: 0.6, startDelaySeconds: 0 },
      { creepType: 'tank', count: 3, intervalSeconds: 1.8, startDelaySeconds: 4.0 },
      { creepType: 'basic', count: 10, intervalSeconds: 0.7, startDelaySeconds: 9.0 },
    ],
  },
  {
    ...
    spawnGroups: [
      { creepType: 'tank', count: 4, intervalSeconds: 1.8, startDelaySeconds: 0 },
      { creepType: 'basic', count: 12, intervalSeconds: 0.7, startDelaySeconds: 4.0 },
      { creepType: 'fast', count: 8, intervalSeconds: 0.6, startDelaySeconds: 10.0 },
    ],
  },
  {
    waveNumber: 6,
    ...
    rewardScore: 420,
    spawnGroups: [
      { creepType: 'fast', count: 12, intervalSeconds: 0.55, startDelaySeconds: 0 },
      { creepType: 'tank', count: 4, intervalSeconds: 1.6, startDelaySeconds: 4.0 },
      { creepType: 'basic', count: 12, intervalSeconds: 0.65, startDelaySeconds: 9.0 },
      { creepType: 'tank', count: 2, intervalSeconds: 1.8, startDelaySeconds: 15.0 },
    ],
  },
  {
    waveNumber: 7,
    ...
    rewardScore: 550,
    spawnGroups: [
      { creepType: 'tank', count: 5, intervalSeconds: 1.6, startDelaySeconds: 0 },
      { creepType: 'fast', count: 12, intervalSeconds: 0.5, startDelaySeconds: 5.0 },
      { creepType: 'basic', count: 14, intervalSeconds: 0.6, startDelaySeconds: 10.0 },
      { creepType: 'tank', count: 4, intervalSeconds: 1.5, startDelaySeconds: 16.0 },
    ],
  },
  {
    waveNumber: 8,
    ...
    spawnGroups: [
      ...
      { creepType: 'boss', count: 1, intervalSeconds: 1.0, startDelaySeconds: 5.0 },
      { creepType: 'fast', count: 12, intervalSeconds: 0.5, startDelaySeconds: 8.0 },
      { creepType: 'basic', count: 14, intervalSeconds: 0.6, startDelaySeconds: 13.0 },
      { creepType: 'tank', count: 4, intervalSeconds: 1.5, startDelaySeconds: 18.0 },
    ],
  },
];
...
const LEVEL_4_WAVES: WaveDefinition[] = [
  {
    ...
    spawnGroups: [
      { creepType: 'basic', count: 8, intervalSeconds: 1.1, startDelaySeconds: 0 },
      { creepType: 'fast', count: 5, intervalSeconds: 0.75, startDelaySeconds: 4.0 },
    ],
  },
  {
    waveNumber: 2,
    ...
    rewardScore: 140,
    spawnGroups: [
      { creepType: 'tank', count: 2, intervalSeconds: 2.0, startDelaySeconds: 0 },
      { creepType: 'basic', count: 9, intervalSeconds: 0.85, startDelaySeconds: 3.0 },
      { creepType: 'fast', count: 6, intervalSeconds: 0.65, startDelaySeconds: 8.0 },
    ],
  },
  {
    waveNumber: 3,
    ...
    rewardScore: 200,
    spawnGroups: [
      { creepType: 'fast', count: 9, intervalSeconds: 0.65, startDelaySeconds: 0 },
      { creepType: 'basic', count: 10, intervalSeconds: 0.75, startDelaySeconds: 4.0 },
      { creepType: 'tank', count: 3, intervalSeconds: 1.8, startDelaySeconds: 9.0 },
    ],
  },
  {
    waveNumber: 4,
    ...
    rewardScore: 280,
    spawnGroups: [
      { creepType: 'tank', count: 4, intervalSeconds: 1.7, startDelaySeconds: 0 },
      { creepType: 'basic', count: 11, intervalSeconds: 0.7, startDelaySeconds: 4.0 },
      { creepType: 'fast', count: 8, intervalSeconds: 0.6, startDelaySeconds: 9.0 },
      { creepType: 'tank', count: 2, intervalSeconds: 1.7, startDelaySeconds: 14.0 },
    ],
  },
  {
    waveNumber: 5,
    ...
    spawnGroups: [
      ...
      { creepType: 'tank', count: 4, intervalSeconds: 1.6, startDelaySeconds: 4.0 },
      { creepType: 'basic', count: 12, intervalSeconds: 0.65, startDelaySeconds: 9.0 },
      { creepType: 'tank', count: 3, intervalSeconds: 1.6, startDelaySeconds: 14.0 },
    ],
  },
  {
    waveNumber: 6,
    ...
    rewardScore: 460,
    spawnGroups: [
      { creepType: 'tank', count: 5, intervalSeconds: 1.5, startDelaySeconds: 0 },
      { creepType: 'basic', count: 14, intervalSeconds: 0.6, startDelaySeconds: 4.0 },
      { creepType: 'fast', count: 12, intervalSeconds: 0.5, startDelaySeconds: 10.0 },
      { creepType: 'tank', count: 3, intervalSeconds: 1.5, startDelaySeconds: 15.0 },
    ],
  },
  {
    waveNumber: 7,
    ...
    rewardScore: 600,
    spawnGroups: [
      { creepType: 'fast', count: 14, intervalSeconds: 0.5, startDelaySeconds: 0 },
      { creepType: 'tank', count: 5, intervalSeconds: 1.4, startDelaySeconds: 4.0 },
      { creepType: 'basic', count: 14, intervalSeconds: 0.55, startDelaySeconds: 9.0 },
      { creepType: 'tank', count: 4, intervalSeconds: 1.4, startDelaySeconds: 15.0 },
    ],
  },
  {
    waveNumber: 8,
    ...
    rewardScore: 750,
    spawnGroups: [
      { creepType: 'tank', count: 6, intervalSeconds: 1.4, startDelaySeconds: 0 },
      { creepType: 'fast', count: 16, intervalSeconds: 0.45, startDelaySeconds: 4.0 },
      { creepType: 'basic', count: 16, intervalSeconds: 0.5, startDelaySeconds: 10.0 },
      { creepType: 'tank', count: 5, intervalSeconds: 1.3, startDelaySeconds: 16.0 },
    ],
  },
  {
    waveNumber: 9,
    ...
    spawnGroups: [
      ...
      { creepType: 'boss', count: 1, intervalSeconds: 1.0, startDelaySeconds: 5.0 },
      { creepType: 'fast', count: 16, intervalSeconds: 0.45, startDelaySeconds: 8.0 },
      { creepType: 'basic', count: 16, intervalSeconds: 0.5, startDelaySeconds: 13.0 },
      { creepType: 'tank', count: 6, intervalSeconds: 1.3, startDelaySeconds: 18.0 },
    ],
  },
];
...
const LEVEL_5_WAVES: WaveDefinition[] = [
  {
    ...
    rewardScore: 100,
    spawnGroups: [
      { creepType: 'basic', count: 9, intervalSeconds: 1.0, startDelaySeconds: 0 },
      { creepType: 'fast', count: 6, intervalSeconds: 0.7, startDelaySeconds: 4.0 },
    ],
  },
  {
    waveNumber: 2,
    ...
    spawnGroups: [
      { creepType: 'fast', count: 9, intervalSeconds: 0.65, startDelaySeconds: 0 },
      { creepType: 'basic', count: 10, intervalSeconds: 0.75, startDelaySeconds: 3.5 },
      { creepType: 'tank', count: 2, intervalSeconds: 1.8, startDelaySeconds: 8.0 },
    ],
  },
  {
    waveNumber: 3,
  ...
  },
  {
    ...
    spawnGroups: [
      { creepType: 'fast', count: 12, intervalSeconds: 0.55, startDelaySeconds: 0 },
      { creepType: 'tank', count: 4, intervalSeconds: 1.6, startDelaySeconds: 4.0 },
      { creepType: 'basic', count: 12, intervalSeconds: 0.6, startDelaySeconds: 9.0 },
      { creepType: 'tank', count: 3, intervalSeconds: 1.6, startDelaySeconds: 14.0 },
    ],
  },
  {
    ...
    spawnGroups: [
      { creepType: 'tank', count: 5, intervalSeconds: 1.5, startDelaySeconds: 0 },
      { creepType: 'basic', count: 14, intervalSeconds: 0.55, startDelaySeconds: 4.0 },
      { creepType: 'fast', count: 12, intervalSeconds: 0.5, startDelaySeconds: 9.0 },
      { creepType: 'tank', count: 3, intervalSeconds: 1.5, startDelaySeconds: 14.0 },
    ],
  },
  {
    waveNumber: 6,
    ...
    spawnGroups: [
      { creepType: 'fast', count: 14, intervalSeconds: 0.5, startDelaySeconds: 0 },
      { creepType: 'tank', count: 5, intervalSeconds: 1.4, startDelaySeconds: 4.0 },
      { creepType: 'basic', count: 14, intervalSeconds: 0.5, startDelaySeconds: 9.0 },
      { creepType: 'tank', count: 4, intervalSeconds: 1.4, startDelaySeconds: 15.0 },
    ],
  },
  {
    ...
    spawnGroups: [
      ...
      { creepType: 'fast', count: 16, intervalSeconds: 0.45, startDelaySeconds: 4.0 },
      { creepType: 'basic', count: 16, intervalSeconds: 0.45, startDelaySeconds: 10.0 },
      { creepType: 'tank', count: 5, intervalSeconds: 1.3, startDelaySeconds: 16.0 },
    ],
  },
  {
    ...
    spawnGroups: [
      ...
      { creepType: 'fast', count: 18, intervalSeconds: 0.4, startDelaySeconds: 4.0 },
      { creepType: 'basic', count: 18, intervalSeconds: 0.45, startDelaySeconds: 10.0 },
      { creepType: 'tank', count: 6, intervalSeconds: 1.2, startDelaySeconds: 16.0 },
    ],
  },
  {
    waveNumber: 9,
    ...
    rewardScore: 1100,
    spawnGroups: [
      { creepType: 'tank', count: 8, intervalSeconds: 1.2, startDelaySeconds: 0 },
      { creepType: 'fast', count: 20, intervalSeconds: 0.38, startDelaySeconds: 4.0 },
      { creepType: 'basic', count: 20, intervalSeconds: 0.4, startDelaySeconds: 10.0 },
      { creepType: 'tank', count: 6, intervalSeconds: 1.1, startDelaySeconds: 16.0 },
    ],
  },
  {
    waveNumber: 10,
    ...
    spawnGroups: [
      { creepType: 'tank', count: 6, intervalSeconds: 1.3, startDelaySeconds: 0 },
      { creepType: 'boss', count: 1, intervalSeconds: 1.0, startDelaySeconds: 5.0 },
      { creepType: 'fast', count: 20, intervalSeconds: 0.38, startDelaySeconds: 8.0 },
      { creepType: 'basic', count: 20, intervalSeconds: 0.4, startDelaySeconds: 14.0 },
      { creepType: 'tank', count: 8, intervalSeconds: 1.1, startDelaySeconds: 20.0 },
    ],
  },
];
